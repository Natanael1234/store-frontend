...
import { UpdateLoggedInUserPasswordHarness } from '@pages/update-logged-in-user-password/update-logged-in-user-password.harness';
...
describe('UpdateLoggedInUserPasswordComponent.', () => {
    ...
    let router: Router;
    let harness: UpdateLoggedInUserPasswordHarness;
    ...
    beforeEach(async () => {
        ...
        harness = await TestbedHarnessEnvironment.harnessForFixture(
            fixture,
            UpdateLoggedInUserPasswordHarness,
        );
    });
