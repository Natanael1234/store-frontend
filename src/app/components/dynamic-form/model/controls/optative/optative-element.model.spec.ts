...
import {
    OptativeElementOptions,
    OptativeFormControl,
} from './optative-element.model';

// Criar uma subclasse concreta para testar a classe abstrata
class TestOptativeControl extends OptativeFormControl {
    public override type: FormElementType = FormElementType.email;
}

describe('OptativeFormControl', () => {
    it('should initialize with options and control', () => {
        const elementOptions: OptativeElementOptions = {
        ...
        expect(control.type).toBe(FormElementType.email);
